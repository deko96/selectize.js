	...
	$.extend(Selectize.prototype, {
		...
		setup: function() {
			...
			$control_input.on({
				...
				focus     : function() { self.ignoreBlur = false; self.ignoreFocus = false; self.trigger('focus'); return self.onFocus.apply(self, arguments); },
		...
		onKeyUp: function(e) {
			...
			// console.log('its a keyup', lengthCheck, value, value.length, self.lastValue, self.lastValue.length);
			// // var lengthCheck = (self.lastValue !== value) && (self.lastValue.length > value.length) && value.length === 0;
			// if (lengthCheck) {
		...
		onBlur: function(e, dest) {
			...
			// 	console.log('focus it again i guess?');
		...
		refreshOptions: function(triggerDropdown) {
			...
			if (self.hasOptions) {
				if (results.items.length > 0 && !$create) {
